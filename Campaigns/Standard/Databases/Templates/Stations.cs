...
namespace LunarLambda.Campaigns.Standard.Databases.Templates
{
    internal static class Stations
    {
        internal static void Load()
        {
            ...
            ShipTemplate template = TemplateDatabase.AddStation(Resources.SmallStationName);
            ...
            template = TemplateDatabase.AddStation(Resources.MediumStationName);
            ...
            template = TemplateDatabase.AddStation(Resources.LargeStationName);
            ...
            template = TemplateDatabase.AddStation(Resources.HugeStationName);
